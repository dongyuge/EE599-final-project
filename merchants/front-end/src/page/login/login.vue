<template>
  ...
  <div class="meituan-content">
      ...
      <div class="login-cont">
        <div class="meituan-title">TrojanEats merchant center</div>
        <div class="meituan-user">
           <img src="../../images/zhanghao.svg" />
           <el-input v-model="name" placeholder="please input count"></el-input>
        </div>
        <div class="meituan-user">
        ...
        <div class="meituan-btn" @click="btNs()">login</div>
      </div>
    </div>
  </div>
</template>
  ...
  export default {
      ...
      methods:{
        ...
        btNs(){
          ...
          .catch((err)=>{
            console.log(err)
            new this.mytitle(this.$message,'info','server error').funtitle()
          })
        },
